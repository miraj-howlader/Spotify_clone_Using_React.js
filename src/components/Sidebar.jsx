...
const Sidebar = () => {
  ...
  return (
    <div
      className="w-[25%] h-full p-2 flex-col gap-2
     text-white hidden lg:flex">
      <div
        className="bg-[#121212] h-[15%] rounded
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded flex flex-col 
        font-semibold items-start gap-1 ">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded flex flex-col 
        font-semibold items-start gap-1 pl-4 mt-4 ">
            <h1>Let's findsome boradcast to follow</h1>
            <p className="font-light">we'll keep you update on noe episode</p>
            <button className="px-4 py-1.5 bg-white text-[15px]
